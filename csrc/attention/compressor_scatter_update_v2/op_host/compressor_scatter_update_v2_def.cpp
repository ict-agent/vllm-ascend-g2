...
namespace ops {
class CompressorScatterUpdateV2 : public OpDef {
public:
    ...
    explicit CompressorScatterUpdateV2(const char *name) : OpDef(name)
    {
        ...
        this->Input("swa_kv_cache")
            .ParamType(REQUIRED)
            .DataType({ge::DT_BF16, ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .IgnoreContiguous();
        this->Input("scatter_indices")
            .ParamType(REQUIRED)
            .DataTypeList({ge::DT_INT32})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        this->Input("scatter_updates")
            .ParamType(REQUIRED)
            .DataType({ge::DT_BF16, ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        ...
        // === Scatter output (2) - in-place update of swa_kv_cache ===
        this->Output("swa_kv_cache")
            .ParamType(REQUIRED)
            .DataType({ge::DT_BF16, ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND});
        ...
        // === Scatter attributes ===
        this->Attr("scatter_strides").AttrType(REQUIRED).ListInt();
        this->Attr("scatter_use_locking").AttrType(OPTIONAL).Bool(false);
        ...
        config910.Input("start_pos")
            ...
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config910.Input("swa_kv_cache")
            .ParamType(REQUIRED)
            .DataType({ge::DT_BF16, ge::DT_FLOAT16, ge::DT_BF16, ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .IgnoreContiguous();
        config910.Input("scatter_indices")
            .ParamType(REQUIRED)
            .DataTypeList({ge::DT_INT32})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config910.Input("scatter_updates")
            .ParamType(REQUIRED)
            .DataType({ge::DT_BF16, ge::DT_FLOAT16, ge::DT_BF16, ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
...
OP_ADD(CompressorScatterUpdateV2, optiling::CompressorScatterUpdateV2CompileInfo);
} // namespace ops